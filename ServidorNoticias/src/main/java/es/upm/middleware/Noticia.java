...
public class Noticia {
	...
	public String toString () {
		...
		noticia.addProperty("nombre", this.nombre);
		noticia.addProperty("fecha", this.fecha);
		noticia.addProperty("nombre", this.nombre);
		noticia.addProperty("categoria", this.categoria);
		JsonArray palabras = new JsonArray();
		for (String element: this.palabras_clave) {
			palabras.add(element.toString());
		}
		noticia.addProperty("palabras_clave", palabras.toString());
		noticia.addProperty("contenido", this.contenido);
